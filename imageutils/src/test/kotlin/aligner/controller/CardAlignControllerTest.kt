...
class CardAlignControllerTest {
    ...
    fun `should convert url to relative project path`() {
        ...
        assertThat(controller.toRelativePath(cardUrl)).isEqualTo("imageutils/src/main/resources/images/cards/salvage.png")
    }
    ...
    fun `should convert relative path to a url`() {
        val cardPath = "imageutils/src/main/resources/images/cards/salvage.png"
        val controller = CardAlignController()
        val url = controller.toUrl(cardPath)
        assertThat(url).startsWith("file:")
        assertThat(url).endsWith("imageutils/src/main/resources/images/cards/salvage.png")
    }
}